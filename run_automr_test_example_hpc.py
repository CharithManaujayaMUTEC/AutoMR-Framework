...
#
# Each transformation can override:
#   start   -> minimum parameter value
#   end     -> maximum parameter value
#   samples -> number of parameter values to evaluate
#
# Only specify transformations you want to customize.
# All remaining transformations use AutoMR defaults.
# ==========================================================
...
if __name__ == "__main__":
    ...
    automr = HighPerformanceAutoMR(
        ...
        # Optional custom transformation ranges.
        # Leave as None to use AutoMR defaults.
