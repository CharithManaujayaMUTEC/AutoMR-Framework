...
# paths
sys.path.append("Path/to/your/dataset")  # Update with your dataset path
sys.path.append("Path/to/your/model")    # Update with your model path
...
# dataset
dataset = load_images("Path/to/your/dataset")  # Update with your dataset path
